const covid19ImpactEstimator = (data) => {
  ...
  const impact = {
    ...
    get dollarsInFlight() {
      const dollarLost = this.infectionsByRequestedTime * data.region.avgDailyIncomePopulation;
      return Math.trunc((dollarLost * data.region.avgDailyIncomeInUSD) / timeToElapse);
    }
  };
  const severeImpact = {
